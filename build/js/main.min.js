...
/* harmony import */ var _modules_page_controller__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/page-controller */ "./js/modules/page-controller.js");
...
document.addEventListener('click', _modules_page_controller__WEBPACK_IMPORTED_MODULE_4__["onPageClick"]);
...
/*!***************************************!*\
  !*** ./js/modules/page-controller.js ***!
  \***************************************/
/*! exports provided: onPageClick */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onPageClick", function() { return onPageClick; });
var desktopWidth = 1024;
var onPageClick = function onPageClick(evt) {
...
var Preloader = /*#__PURE__*/function () {
  function Preloader(element, nextElementForAnimation) {
  ...
  _createClass(Preloader, [{
    ...
    value: function hide() {
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          _this.nextElementForAnimation.classList.remove('animate');
        }, _this.durationFadeout);
      }, this.durationFadeout);
    }
  }, {
    key: "onDownEnter",
    value: function onDownEnter(evt) {
      if (evt.key === 'Enter') {
        this.hide();
      }
    }
...
var preloader = function preloader() {
  ...
  var nextForAnimationNode = document.querySelector('.intro');
